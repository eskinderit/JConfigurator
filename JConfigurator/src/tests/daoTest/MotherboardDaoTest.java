...
public class MotherboardDaoTest {
	...
	void testAddComponents_repeated() throws JAXBException {
		...
		motherboardDao.addComponents(motherboardList);
		motherboardDao.addComponents(motherboardList);
		assertEquals(localmotherboardList, motherboardDao.readComponents(),
				"Can only add the same motherboardList once");
		motherboardDao.addComponents(motherboardList);
		localmotherboardList.addAll(motherboardList);
		assertNotEquals(localmotherboardList, motherboardDao.readComponents(),
				"Can only add the same motherboardList once");
	}
