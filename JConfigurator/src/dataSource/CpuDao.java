...
public class CpuDao extends ComponentDao<Cpu, CpuDao> {
	...
	public ArrayList<Cpu> setDefaultComponents() throws JAXBException {
		this.cpuList = this._setDefaultComponents("src/dataSource/xmlSource/CpuDefault.Xml",
				"src/dataSource/xmlSource/Cpu.Xml", CpuDao.class);
		return this.cpuList;
	}
	...
	public ArrayList<Cpu> setEmptyComponents() throws JAXBException {
		this.cpuList = this._setDefaultComponents("src/dataSource/xmlSource/EmptyCpu.Xml",
				"src/dataSource/xmlSource/Cpu.Xml", CpuDao.class);
		return this.cpuList;
	}
