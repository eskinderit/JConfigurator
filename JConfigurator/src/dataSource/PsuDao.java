...
public class PsuDao extends ComponentDao<Psu, PsuDao> {
	...
	public ArrayList<Psu> setDefaultComponents() throws JAXBException {
		this.psuList = this._setDefaultComponents("src/dataSource/xmlSource/PsuDefault.Xml",
				"src/dataSource/xmlSource/Psu.Xml", PsuDao.class);
		return this.psuList;
	}

	@Override
	public ArrayList<Psu> setEmptyComponents() throws JAXBException {
		this.psuList = this._setDefaultComponents("src/dataSource/xmlSource/EmptyPsu.Xml",
				"src/dataSource/xmlSource/Psu.Xml", PsuDao.class);
		return this.psuList;
	}
